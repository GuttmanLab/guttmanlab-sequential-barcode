 ...
 *
 */
public class BarcodedDNAFragment extends BarcodedFragmentImpl {
	 ...
	 */
	public BarcodedDNAFragment(String fragmentId, String read1seq, String read2seq, ReadLayout layoutRead1, ReadLayout layoutRead2, int maxMismatchesBarcode) {
